...
with open('../data/UnderlyingClusters.txt') as reader, open('training_data.txt', 'w') as writer:
    for index, line in enumerate(reader):
        if index%11 != 0:
            writer.write(line)

with open("training_data.txt", "r") as my_train_file, open("../data/EncodedStrands.txt", "r") as my_train_file_2:
